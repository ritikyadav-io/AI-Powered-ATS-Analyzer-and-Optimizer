          ...
          {stage === "results" && result && (
            <motion.div key="results" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
              ...
              <div className="grid gap-4 sm:gap-6 grid-cols-1 lg:grid-cols-2">
                ...
                {/* 4. Standalone Live Job Openings & Career Opportunities Section */}
                <div className="rounded-xl border border-border/80 bg-card p-6 flex flex-col gap-5 shadow-sm">
                  ...
                  {result.jobOpenings && result.jobOpenings.length > 0 ? (
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {result.jobOpenings.map((job, idx) => (
                        <div
                          key={idx}
                          className="rounded-xl border border-border/80 bg-background/80 p-4 flex flex-col justify-between gap-3 hover:border-accent/50 hover:shadow-md transition-all group"
                        >
                          <div className="space-y-1.5">
                            <div className="flex items-center justify-between gap-2">
                              <span className="font-mono text-[10px] font-bold text-accent uppercase tracking-wider bg-accent/10 px-2 py-0.5 rounded">
                                {company || "Hiring Partner"}
                              </span>
                              <span className="text-[10px] text-muted-foreground font-mono">Live Listing</span>
                            </div>
                          ...
                          <a
                            ...
                            className="inline-flex items-center justify-center gap-2 w-full py-2 px-3 rounded-lg bg-accent text-white text-xs font-semibold hover:bg-accent/90 transition-all shadow-xs"
                          >
                            Apply / View Official Listing <ExternalLink className="h-3.5 w-3.5" />
                          </a>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="rounded-xl border border-border/60 bg-background/50 p-6 text-center space-y-3">
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
                        ...
                        >
                          Search Google Jobs <ExternalLink className="h-3.5 w-3.5" />
                        </a>
                      </div>
                    </div>
                  )}
